...
public class Demos_telerik_RightToLeft {
	...
	driver.findElement(By.xpath("//span[@class='rlbButtonIcon rlbIconTransferAllLeft']")).click();
	
	try{
		Thread.sleep(2000);
		driver.findElement(By.xpath("//div[@id='ctl00_ContentPlaceholder1_RadListBoxSource']/div/ul/li[contains (text(),'Australia')]"));
		driver.findElement(By.xpath("//div[@id='ctl00_ContentPlaceholder1_RadListBoxSource']/div/ul/li[contains (text(),'Canada')]"));
		driver.findElement(By.xpath("//div[@id='ctl00_ContentPlaceholder1_RadListBoxSource']/div/ul/li[contains (text(),'India')]"));
		System.out.println("Countries moved back to source");
	}catch (Exception e){
		System.out.println("Failed : Element not moved back to Source");
	}
	}
